  ...
  const handleImageSubmit = (e) => {
    if (files.length > 0 && files.length + formData.imageUrls.length < 7) {
      ...
      Promise.all(promises)
        ...
        .catch((error) => {
          setImageUploadError("Image upload failed (5 mb limit per image)");
          setUploading(false);
        });
    } else {
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="p-3 text-white bg-green-600 rounded uppercase hover:bg-green-700 font-semibold"
            >
          ...
          {formData.imageUrls.length > 0 &&
            formData.imageUrls.map((url, index) => (
              <div
                key={url}
                className="flex justify-between p-3 border border-gray-400 items-center"
              >
                <img
                  src={url}
                  alt="listing image"
                ...
                <button
                  ...
                  className="p-3 text-red-500 rounded-lg uppercase hover:text-red-700 font-semibold"
                >
                  Delete
                </button>
              </div>
          ...
          <button
            ...
            className="p-3 bg-blue-500 text-white rounded-lg uppercase hover:bg-blue-700 font-semibold"
          >
